...
<head>
  <title>Профессия Детский психолог | Онлайн университет Talentsy</title>
  <?php include('../templates/head.php'); ?>
</head>

<body class="page-psychology-kid">

  <?php include('../templates/header.php'); ?>

  <section class="hero hero--kids">
    <div class="hero__h1 jbm">
      За 1,5 года сделаем <img src="/img/psychology-kid/b1-sm.webp" alt=""> из вас <br>
    ...
    <div class="hero__videowrap ">
      <div class="hero__videobox square">
        <video class="hero__video square__img" preload="auto" playsinline="" autoplay="" loop="" muted="">
          <source src="/img/psychology-kid/b1-video.mp4">
        </video>
      </div>
    ...
    <div class="container">
      ...
      <div class="iphone__wrap flexi">
        <aside class="iphone__right">
          <img data-src="/img/psychology/b2-mock.png" alt="" class="iphone__mock lazy">
          <video preload="auto" playsinline="" autoplay="" loop="" muted="" class="iphone__mockvideo">
            <source src="/img/psychology/b2-vid.mp4">
          </video>
        </aside>
        <div class="iphone__grid">
          <div class="iphone__prop">
            <img data-src="/img/psychology/b2-1.png" alt="" class="iphone__propicon lazy js-slide-opac">
          ...
          <div class="iphone__prop">
            <img data-src="/img/psychology/b2-2.png" alt="" class="iphone__propicon lazy js-slide-opac">
          ...
          <div class="iphone__prop">
            <img data-src="/img/psychology-kid/b2-4.webp" alt="" class="iphone__propicon lazy js-slide-opac">
        ...
        <div class="dreams__grid">
          <div class="dreams__item dreams__item--border">
            <div class="dreams__iconwrap">
              <img data-src="/img/psychology-kid/b4-1.webp" alt="" class="lazy js-slide-opac">
            </div>
          ...
          <div class="dreams__item">
            <div class="dreams__iconwrap dreams__iconwrap--wide">
              <img data-src="/img/psychology-kid/b4-2.webp" alt="" class="lazy js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item dreams__item--bg">
            <div class="dreams__iconwrap">
              <img data-src="/img/psychology-kid/b4-3.webp" alt="" class="lazy">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item  dreams__item--light">
            <div class="dreams__iconwrap">
              <img data-src="/img/psychology-kid/b4-4-1.svg" alt="" class="lazy js-slide-opac">
              <img src="/img/psychology-kid/b4-4-2.svg" alt="" class="dreams__heart">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item">
            <div class="dreams__iconwrap">
              <img data-src="/img/psychology/b4-5.png" alt="" class="lazy js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item  dreams__item--border dreams__item--light">
            <div class="dreams__iconwrap dreams__iconwrap--wide">
              <img data-src="/img/psychology/b4-6.jpg" alt="" class="lazy js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="swiper-wrapper">
            <?php foreach (range(1, 17, 1) as $key => $videoNum) : ?>
              <div class="swiper-slide">
                <a href="/img/psychology/reviews/<?= str_pad($videoNum, 3, '0', STR_PAD_LEFT); ?>-full.mp4" class="reviewsslider__videowrap square" data-ratio="0.5625" data-fancybox="reviewVideo">
                  <video loop muted playsinline preload="auto" controlslist="nodownload" disablepictureinpicture="" crossorigin="anonymous" class="reviewsslider__screen square__img lazy">
                    <source data-src="/img/psychology/reviews/<?= str_pad($videoNum, 3, '0', STR_PAD_LEFT); ?>.mp4">
                  </video>
  ...
  <section class="psy6">
    <div class="container">
      ...
      <div class="psy6__wrap">
        ...
        <div class="psy6__item js-slide-interval">
          <img src="/img/psychology/b6-2.svg" alt="" class="psy6__icon">
          <div class="psy6__text">
            Детский психолог - одна из немногих профессий, спрос на которую в любые сложные времена <b>только растет</b>
          </div>
        </div>
        <div class="psy6__item js-slide-interval">
          <img src="/img/psychology/b6-3.png" alt="" class="psy6__icon">
          <div class="psy6__text">
    ...
    <div class="container">
      ...
      <div class="psy7__wrap">
        <div class="psy7__item js-slide-interval">
          <img src="/img/psychology-kid/b8-1.svg" alt="" class="psy7__icon">
        ...
        <div class="psy7__item js-slide-interval">
          <img src="/img/psychology-kid/b8-2.svg" alt="" class="psy7__icon">
        ...
        <div class="psy7__item js-slide-interval">
          <img src="/img/psychology-kid/b8-3.svg" alt="" class="psy7__icon">
        ...
        <div class="psy7__item js-slide-interval">
          <img src="/img/psychology-kid/b8-4.svg" alt="" class="psy7__icon">
  ...
  <section class="psy8 psy8--kids">
    <div class="container">
      ...
      <img data-src="/img/psychology/b8-bg.png" alt="" class="psy8__bg lazy" style="aspect-ratio: 1680 / 739;">
    ...
    <div class="container">
      ...
      <div class="mentorsfeat">
        <div class="mentorsfeat__item">
          <img src="/img/psychology/b9-1.svg" alt="" class="mentorsfeat__icon js-slide-opac">
        ...
        <div class="mentorsfeat__item">
          <img src="/img/psychology/b9-2.svg" alt="" class="mentorsfeat__icon js-slide-opac">
        ...
        <div class="mentorsfeat__item">
          <img src="/img/psychology/b9-3.svg" alt="" class="mentorsfeat__icon js-slide-opac">
      ...
      <div class="teamblock flexi">
        ...
        <div class="swiper teamslider js-team-slider">
          <div class="swiper-wrapper">
            ...
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                <img src="/img/psychology/mentors/002.jpg" alt="" class="teamslider__photo">
            ...
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                <img src="/img/psychology/mentors/003.jpg" alt="" class="teamslider__photo">
            ...
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                <img src="/img/psychology/mentors/005.jpg" alt="" class="teamslider__photo">
            ...
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                <img src="/img/psychology/mentors/006.jpg" alt="" class="teamslider__photo">
            ...
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                <img src="/img/psychology/mentors/007.jpg" alt="" class="teamslider__photo">
            ...
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                <img src="/img/mentors/dolgushin.webp" alt="" class="teamslider__photo">
            ...
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                <img src="/img/psychology/mentors/011.jpg" alt="" class="teamslider__photo">
            ...
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                <img src="/img/psychology/mentors/012.jpg" alt="" class="teamslider__photo">
            ...
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                <img src="/img/psychology/mentors/013.jpg" alt="" class="teamslider__photo">
            ...
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                <img src="/img/psychology/mentors/014.jpg" alt="" class="teamslider__photo">
    ...
    <div class="container">
      ...
      <div class="regalii__grid">
        <div class="regalii__item">
          <img data-src="/img/psychology/b10-1.png" alt="" class="lazy js-slide-opac">
          <div class="regalii__title">Российское психологическое общество</div>
        </div>
        <div class="regalii__item">
          <img data-src="/img/psychology/b10-2.png" alt="" class="lazy js-slide-opac">
          <div class="regalii__title">Российская психотерапевти-<br>ческая лига</div>
        </div>
        <div class="regalii__item">
          <img data-src="/img/psychology/b10-3.png" alt="" class="lazy js-slide-opac">
          <div class="regalii__title">Американская психологическая ассоциация</div>
        </div>
        <div class="regalii__item">
          <img data-src="/img/psychology/b10-4.png" alt="" class="lazy js-slide-opac">
      ...
      <div class="features__wrap">
        <div class="features__left js-slide-bot">
          <video preload="auto" playsinline autoplay loop muted class="lazy">
            <source data-src="/img/psychology/b12-video.mp4">
          </video>
        </div>
  ...
  <section class="progrmsummary container">
    ...
    <div class="progrmsummary__wrap">
      ...
      <?php require_once(__DIR__ . '/_program.php'); ?>
  ...
  <section class="guideform">
    <div class="container">
      <h3 class="guideform__title title js-slide-bot">
        ...
        <img src="/img/psychology-kid/b15-catalog.webp" alt="" class="psy-kid-catalog">
      </h3>
      <?php
  ...
  <section class="features psy15">
    <div class="container">
      ...
      <div class="features__wrap">
        <div class="features__left js-slide-bot">
          <video preload="auto" playsinline autoplay loop muted class="lazy">
            <source data-src="/img/psychology/b15-video.mp4">
          </video>
        </div>
        <div class="features__right">
          <div class="features__subtitle">
          ...
          <div class="features__grid">
            <div class="features__item">
              <img src="/img/psychology/b15-1.png" alt="" class="js-slide-opac">
              <p>Каждый получит <br><b>достаточно внимания наставника</b></p>
            </div>
            <div class="features__item">
              <img src="/img/psychology/b15-2.png" alt="" class="js-slide-opac">
              <p><b>Участники группы</b> мотивируют и помогают друг другу</p>
            </div>
            <div class="features__item">
              <img src="/img/psychology/b15-3.png" alt="" class="js-slide-opac">
  ...
  <section class="features psy16">
    <div class="container">
      ...
      <div class="features__wrap">
        <div class="features__left js-slide-bot">
          <img src="/img/psychology/b16-collage.jpg" alt="" class="psy16__collage">
        </div>
        <div class="features__right">
          <div class="features__grid">
            <div class="features__item">
              <picture class="js-slide-opac">
                <source media="(min-width: 768px)" srcset="/img/psychology/b16-1.jpg">
                <img src="/img/psychology/b16-1m.png" alt="">
              </picture>
            ...
            <div class="features__item">
              <picture class="js-slide-opac">
                ...
                <img src="/img/psychology/b16-2m.png" alt="">
              </picture>
  ...
  <section class="diplomblock">
    <div class="container">
      ...
      <div class="swiper js-diplomblock-slider">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img src="/img/psychology-kid/diplom-1.webp" alt="" class="diplomblock__sl-pic">
          </div>
          <div class="swiper-slide">
            <img src="/img/psychology-kid/diplom-2.webp" alt="" class="diplomblock__sl-pic">
          </div>
        </div>
        <button class="ctrl ctrl--prev"><img src="/img/ui/slider-ctrl.svg" alt=""></button>
        <button class="ctrl ctrl--next"><img src="/img/ui/slider-ctrl.svg" alt=""></button>
  ...
  <section class="timeslot">
    <div class="container">
      ...
      <div class="timeslot__box">
        <img src="/img/psychology/b19-bg.svg" alt="" class="timeslot__bg">
  ...
  <section class="statistic container psy20">
    ...
    <div class="statistic__grid">
      <dl class="statistic__item statistic__item--verbg">
        <dt>16<img src="/img/psychology/b20-star.svg" alt="" class="statistic__star"></dt>
    ...
    <div class="container">
      ...
      <div class="grid-mob-scroll">
        <div class="dreams__grid">
          <div class="dreams__item dreams__item--border">
            <div class="dreams__iconwrap">
              <img src="/img/psychology-kid/b22-1.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item">
            <div class="dreams__iconwrap dreams__iconwrap--wide">
              <img src="/img/psychology-kid/b22-2.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item dreams__item--bg">
            <div class="dreams__iconwrap">
              <img src="/img/psychology-kid/b22-3.webp" alt="">
            </div>
          ...
          <div class="dreams__item">
            <div class="dreams__iconwrap">
              <img src="/img/psychology-kid/b22-4.svg" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item">
            <div class="dreams__iconwrap">
              <img src="/img/psychology-kid/b22-5.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item">
            <div class="dreams__iconwrap dreams__iconwrap--wide">
              <img src="/img/psychology-kid/b22-6.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item">
            <div class="dreams__iconwrap">
              <img src="/img/psychology-kid/b22-7.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item dreams__item--border">
            <div class="dreams__iconwrap">
              <img src="/img/psychology-kid/b22-8.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
    ...
    <div class="container">
      ...
      <div class="talentsyabout__props">
        ...
        <dl class="talentsyabout__prop talentsyabout__prop--yellow">
          <dt class="js-slide-opac">13k<img src="/img/footer/props-heart.svg" alt="" class="talentsyabout__heart"></dt>
      ...
      <div class="townsmarquee jbm js-towns-marquee">
        <div class="townsmarquee__line1 flexi"><?php include(__DIR__ . '/_towns.php'); ?></div>
        <div class="townsmarquee__line2 flexi"><?php include(__DIR__ . '/_towns.php'); ?></div>
        <div class="townsmarquee__line1 flexi"><?php include(__DIR__ . '/_towns.php'); ?></div>
      </div>
